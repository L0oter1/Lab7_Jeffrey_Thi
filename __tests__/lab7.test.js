describe('Basic user flow for Website', () => {
  ...
  it('Make sure <product-item> elements are populated', async () => {
    ...
    // Implement a for loop through prodItemsData to for the given if statements
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    // Get the button associated with that item
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    // lab FAQ said I can choose not to click first element since everything related
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (let i = 0; i < productItems.length; i++) {
      ...
      // Expect it to say "Remove from Cart"
  ...
  it('Checking number of items in cart on screen after removing from cart', async () => {
    ...
    //clicking remove from cart from every item
    for (let i = 0; i < productItems.length; i++) {
      const item = productItems[i];
      const shadowRoot = await item.getProperty('shadowRoot');   
      const button = await shadowRoot.$('button');
  ...
  it('Checking the localStorage to make sure cart is correct', async () => {
    ...
    // Expect it to be an empty array
    expect(cart).toBe('[]');
